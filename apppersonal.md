...
- Selección de colores personalizada y expandida para la identificación visual
- Extensa galería de íconos disponibles para ilustrar cada regla
...
- **Módulo de Perfil y Preferencias**
  ...
  - Detección y ajuste automático de la Zona Horaria (basada en el dispositivo móvil/PC en uso) para que siempre las fechas y horas sean las correctas para la ubicación actual del usuario.
...
**Funcionalidades:**
- Paleta predeterminada exclusiva con 14 colores fijos para la selección en Cuentas, Porcentajes y Categorías (No color picker libre).
...
- [x] Autenticación email + Google OAuth 2.0
- [x] CRUD Transacciones (ingresos/egresos con categorías y cuentas)
- [x] CRUD Categorías (icono, color, tipo)
- [x] Dashboard con resumen mensual, alertas y versículo
- [x] Gestión de perfil (avatar, moneda, contraseña, URL de app)

### Fase 2 - Core Features ✅ Mayormente Completada:
- [x] Sistema de Porcentajes (CRUD + barras de progreso)
- [x] Cuentas Mensuales / Gastos Fijos con recordatorios
- [x] Estadísticas básicas (gráficos de barras y pastel)
- [x] Push Notifications (Service Worker + cron de recordatorios)
- [x] Tema oscuro / claro
- [x] **Módulo de Fondos y Metas de Ahorro** ← NUEVO
  - [x] Fondo de emergencias (especial, único por usuario)
  - [x] Metas de ahorro personalizadas (ícono, color, meta, fecha límite)
  - [x] Progreso visual (LinearProgress) con % completado
  - [x] Vinculación a cuenta bancaria o efectivo
  - [x] Depósitos con historial
...
- [ ] OCR para escanear facturas con imagen
- [ ] Presupuestos por categoría con alertas
- [ ] Estadísticas avanzadas completas (historial anual, tendencias)
